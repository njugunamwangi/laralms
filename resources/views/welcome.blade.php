        ...
        <div class="bg-gray-900">
            <header class="absolute inset-x-0 top-0 z-50">
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    @if(!Auth::check())
                        <a wire:navigate href="{{ route('login') }}"  class="text-sm font-semibold leading-6 text-white">Log in <span aria-hidden="true">&rarr;</span></a>
                    @else
                        @if(auth()->user()->hasRole(App\Models\Role::ADMIN))
                            <a href="{{ route('login') }}" class="text-sm font-semibold leading-6 text-white">Admin <span aria-hidden="true"></span></a>
                        @endif
                    @endif
                </div>
                </nav>
            ...
            <div class="relative isolate pt-14">
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a wire:navigate href="{{ route('register') }}" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">
                            Get started
                        </a>
